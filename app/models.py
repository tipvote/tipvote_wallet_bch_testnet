...
class User(db.Model):
    ...
    legal_reply_sender_msg = db.relationship('LegalReply', backref='legal_replysendermsg', lazy='dynamic',
                                             cascade="all,delete",
                                             primaryjoin="User.id == LegalReply.sender_user_id")
    legal_reply_rec_msg = db.relationship('LegalReply', backref='legal_replyrecmsg', lazy='dynamic',
                                          cascade="all,delete",
